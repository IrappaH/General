...
public class SharedFolderSmokeTest extends InitialTestSetup {
	...
	public void verifyAppBuildVersion() throws Exception {
		setTestDesc("Verify that App version");
		String AppBuildVersion = sharedFolder.getAppBuildVersion().getText();
...
//	@PriorityInClass(4)
	...
	public void verifyFolderFileFolderMoveToPersonalFolder() throws Exception {
		setTestDesc("Verify that Admin can move multiple files/folders from personal folder to the Shared folders.");
