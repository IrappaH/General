...
public class CreateFolderInPersonalRootFolderSharedFolder extends InitialTestSetup {
...
/*
	...
	public void verifyFolderIsEmpty() throws Exception {
		personalFolder = homePage.gotoSharedFolder();
		Thread.sleep(2000);
	...
	public void verifySpecialCharFolderIsCreated() throws Exception {
		setTestDesc(
				"Verify that Creating Folder name can be Special characters in the Root folder.Folder should be created ");
		personalFolderCreation = personalFolder.gotoPersonalFolderCreation();
