...
public class SharedFolder extends BasePage{
	...
	public String deviceManagementheader()throws Exception {
		// TODO Auto-generated method stub
		return this.uiControl("deviceManagementheader").getText();
	}

	public String listOfDevices() throws Exception {
		
		return this.uiControl("backUpdevicelist").getText();
	}
	...
	public UIControl OpenFileVersion() throws Exception {
		// TODO Auto-generated method stub
		return this.uiControl("fileVersion");
	}

	public UIControl getFileVersionHeader() throws Exception {
		return this.uiControl("fileversionheader");
	}

	public UIControl CloseFileVersion() throws Exception{
		
		return this.uiControl("closeFileversion");
		
	}

	public UIControl OpenDeviceManagement() throws Exception {
		return this.uiControl("openDeviceManagement");
		
	}

	public UIControl backupdeviceCheckBox() throws Exception {
	...
	public UIControl Emptydevice() throws Exception {
		
		return this.uiControl("emptyDevice");
		
	}

	public UIControl ClickSettings() throws Exception {
			
			return this.uiControl("settings");
	}

	public UIControl ClickOnNumberGenerationBk() throws Exception {
		return this.uiControl("numberofgeneration");
	}

	public UIControl Select5option()throws Exception {
		return this.uiControl("firstoption");
	}
	...
	public UIControl getStringMsg() throws Exception {
		
			return this.uiControl("stringMsg");
