...
public class SharedFolder extends BasePage{
	...
	public boolean CheckNewTabWindowDisplayed() throws Exception {
		...
		boolean checkWindowExist = switchWindow("100jobs_20240616_000950.pdf","https://m7.networkprint.jp/backup");
	...
	public UIControl AddressBookValueCSV() throws Exception {
		return this.uiControl("addressBookvaluecsv");
	}

	public UIControl ClickCSVInputBtn() throws Exception {
		return this.uiControl("inputFromCSV");
	}

	public UIControl SelectEntry() throws Exception {
		return this.uiControl("selectEntry");
	}
	
	public UIControl ClickSettingsDeletebtn() throws Exception {
		return this.uiControl("settingsdeletebtn");
	}

	public UIControl ClickOnCSV() throws Exception {
		return this.uiControl("csvdownload");
	}
