...
public class FaxSmokeTest extends InitialTestSetup {
	...
	public void verifyIndividualFolderDownload() throws Exception {
		setTestDesc("Verify that Admin can Download - Individual file or folder");
		sharedFolder.Openfolder().click();
		Thread.sleep(1000);
		sharedFolder.Openfolder().click();
		Thread.sleep(1000);
	...
	public void verifyDeviceListDisplayed() throws Exception {
		setTestDesc("Verify that Device list are displayed");
	...
	public void verifySettingsFilesSortedByDate() throws Exception {
		setTestDesc("Verify that Files should be sorted by date");
	...
	public void verifySettingsFilesSortedByCompany() throws Exception {
		setTestDesc("Verify that Files should be sorted by Company");
		sharedFolder.ClickSettings().click();
		Thread.sleep(1000);
	...
	public void verifySettingsDirectInput() throws Exception {
		setTestDesc("Verify that Direct input and set");
		sharedFolder.ClickSettings().click();
		Thread.sleep(1000);
	...
	public void verifySettingsInputFromCSV() throws Exception {
		setTestDesc("Verify that Input from CSV and set");
		Thread.sleep(1000);
		sharedFolder.ClickSettings().click();
		Thread.sleep(1000);
	...
	{
		setTestDesc("Verify that Select a address book entry and delete and set");
		Thread.sleep(1000);
		sharedFolder.ClickSettings().click();
		Thread.sleep(1000);
		sharedFolder.SelectEntry().click();
		Thread.sleep(1000);
		sharedFolder.ClickSettingsDeletebtn().click();
		Thread.sleep(1000);
	...
	public void verifyDeviceListDelete() throws Exception {
		setTestDesc("Verify that Select single device and delete");
		sharedFolder.ClickDeviceManagemnt().click();
		Thread.sleep(1000);
		String BeforeDltfileCnt = sharedFolder.getFileCount();
